...
\frame{
  ...
  {\scriptsize
  \begin{table}
    \caption{\scriptsize Bandwidth GB/s \footnote{\scriptsize \textcolor{blue}{Updated Nov 28, 2020}} }
    \label{table_memory}
...
\frame{
  ...
  Reproduce results with \texttt{sbatch ./script/testCase\_Comm/runTestCasesShaheen.sbatch}
