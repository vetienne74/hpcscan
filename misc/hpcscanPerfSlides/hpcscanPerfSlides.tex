...
%-------------------------------------------------------------------------------------
\frame{
  \frametitle{Test Case Memory - NEC SX-Aurora TSUBASA XX \footnote{\scriptsize \textcolor{blue}{Results updated Dec XX, 2022}} }

  \begin{figure}
    \begin{center}
      %\includegraphics[width=1.0 \textwidth]{../../script/testCase_Memory/hpcscanMemoryProto27.png}
      \includegraphics[width=0.5 \textwidth]{./Images/InProgress.jpg}
    \end{center}
  \end{figure}
}
...
%-------------------------------------------------------------------------------------
\frame{
  \frametitle{Test Case Grid - NEC SX-Aurora TSUBASA XX \footnote{\scriptsize \textcolor{blue}{Results updated Dec XX, 2022}} }

  \begin{figure}
    \begin{center}
      %\includegraphics[width=1.0 \textwidth]{../../script/testCase_Grid/hpcscanGridProto27.png}
      \includegraphics[width=0.5 \textwidth]{./Images/InProgress.jpg}
    \end{center}
  \end{figure}

  ApplyBoundaryCondition performs at XXX/XXX GBytes (XX/XXX Gpoint/s)
}
