...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for iarch = [1 2 3 4 5 6 7]
    
    switch iarch
        case 1
            FILE = 'FD_D2.xgpt435.Baseline.2021-07-26' ;
            ARCH = 'CPU' ;
            MODE = 'Baseline' ;
            COLORPLOT = 'b' ;
            WIDTHPLOT = 1.0 ;
        ...
        case 2
            FILE = 'FD_D2.xgpt435.CacheBlk.2021-07-26' ;
            ARCH = 'CPU' ;
            MODE = 'CacheBlk' ;
            COLORPLOT = 'b' ;
            WIDTHPLOT = 1.0 ;
        ...
        case 3
            FILE = 'FD_D2.xgpv21.CUDA.2021-07-25' ;
            ARCH = 'GPU' ;
            MODE = 'Regular' ;
            COLORPLOT = '#77AC30' ;
            WIDTHPLOT = 0.5 ;
        ...
        case 4
            FILE = 'FD_D2.xgpv21.CUDA_Opt.2021-07-25' ;
            ARCH = 'GPU' ;
            MODE = 'Optim' ;
            COLORPLOT = '#77AC30' ;
            WIDTHPLOT = 1.5 ;
        ...
        case 5
            FILE = 'FD_D2.plconec01.Baseline.2021-06-20' ;
            ARCH = 'SX-Aurora'
            MODE = 'Baseline' ;           
            COLORPLOT = 'r' ;
            WIDTHPLOT = 1.0 ;
        ...
        case 6
            FILE = 'FD_D2.plconec01.NEC.2021-06-27' ;
            ARCH = 'SX-Aurora'
            MODE = 'NEC' ;
            COLORPLOT = 'r' ;
            WIDTHPLOT = 0.5 ;
        ...
        case 7
            FILE = 'FD_D2.plconec01.NEC_SCA.2021-06-27' ;
            ARCH = 'SX-Aurora'
            MODE = 'SCA' ;
            COLORPLOT = 'r' ;
            WIDTHPLOT = 1.5 ;
