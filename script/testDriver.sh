...
# 1D all orders
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 2  -dim 1 >> ${report_file}
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 4  -dim 1 >> ${report_file}
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 6  -dim 1 >> ${report_file}
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 8  -dim 1 >> ${report_file}
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 10 -dim 1 >> ${report_file}
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 12 -dim 1 >> ${report_file}
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 14 -dim 1 >> ${report_file}
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 16 -dim 1 >> ${report_file}

# 2D all orders
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 2  -dim 2 >> ${report_file}
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 4  -dim 2 >> ${report_file}
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 6  -dim 2 >> ${report_file}
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 8  -dim 2 >> ${report_file}
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 10 -dim 2 >> ${report_file}
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 12 -dim 2 >> ${report_file}
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 14 -dim 2 >> ${report_file}
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 16 -dim 2 >> ${report_file}

# 3D all orders
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 2  -dim 3 >> ${report_file}
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 4  -dim 3 >> ${report_file}
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 6  -dim 3 >> ${report_file}
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 8  -dim 3 >> ${report_file}
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 10 -dim 3 >> ${report_file}
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 12 -dim 3 >> ${report_file}
$HPCSCAN_MPI_INVOKER -n 1 ../bin/hpcscan -ntry 1 -testMode ${tM} -testCase ${testCase} -fdOrder 14 -dim 3 >> ${report_file}
