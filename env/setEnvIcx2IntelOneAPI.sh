...
export HPCSCAN_CPP_FLAGCOMP='-xICELAKE-SERVER -w -g -O3 -fopenmp -std=c++11 -qopt-zmm-usage=high -no-prec-div -no-prec-sqrt -fno-fnalias -fno-nalias -ftz -fma -fp-model fast=2  -qopt-dynamic-alig -fimf-use-svml=true -fimf-precision -qopt-report=3 -qopt-report-annotate=text -qopt-report-phase=vecq'
