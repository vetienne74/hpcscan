...
#ifndef HPCSCAN_GRID_CUSTOM_H_
#define HPCSCAN_GRID_CUSTOM_H_
...
class Grid_Custom : public Grid
{
public:

	// constructor
	Grid_Custom(Grid_type) ;

	// constructor
	Grid_Custom(Grid_type, Dim_type, Myint64, Myint64, Myint64) ;
