...
Rtn_code Grid_NEC_SCA::initialize_code_FD_D2_N1(Point_type pType, const Grid& Wgrid, Myint fdOrder)
{
	...
	if (!flag_code_FD_D2_N1)
	{
		...
		{
			sca_stencil_set_location(sten, 0, -3, 0, 0, 0); sca_stencil_set_factor(sten, 0, FD_D2_O6_A3 * inv2_d1); // i1-3, i2, i3
			sca_stencil_set_location(sten, 1, -2, 0, 0, 0); sca_stencil_set_factor(sten, 1, FD_D2_O6_A2 * inv2_d1); // i1-2, i2, i3
			sca_stencil_set_location(sten, 2, -1, 0, 0, 0); sca_stencil_set_factor(sten, 2, FD_D2_O6_A1 * inv2_d1); // i1-1, i2, i3
			sca_stencil_set_location(sten, 3,  0, 0, 0, 0); sca_stencil_set_factor(sten, 3, FD_D2_O6_A0 * inv2_d1); // i1  , i2, i3
			sca_stencil_set_location(sten, 4,  1, 0, 0, 0); sca_stencil_set_factor(sten, 4, FD_D2_O6_A1 * inv2_d1); // i1+1, i2, i3
			sca_stencil_set_location(sten, 5,  2, 0, 0, 0); sca_stencil_set_factor(sten, 5, FD_D2_O6_A2 * inv2_d1); // i1+2, i2, i3
			sca_stencil_set_location(sten, 6,  3, 0, 0, 0); sca_stencil_set_factor(sten, 6, FD_D2_O6_A3 * inv2_d1); // i1+3, i2, i3
		}
		else if (fdOrder == 8)
		{
		...
		{
			sca_stencil_set_location(sten,  0, -5, 0, 0, 0); sca_stencil_set_factor(sten,  0, FD_D2_O10_A5 * inv2_d1); // i1-5, i2, i3
			sca_stencil_set_location(sten,  1, -4, 0, 0, 0); sca_stencil_set_factor(sten,  1, FD_D2_O10_A4 * inv2_d1); // i1-4, i2, i3
			sca_stencil_set_location(sten,  2, -3, 0, 0, 0); sca_stencil_set_factor(sten,  2, FD_D2_O10_A3 * inv2_d1); // i1-3, i2, i3
			sca_stencil_set_location(sten,  3, -2, 0, 0, 0); sca_stencil_set_factor(sten,  3, FD_D2_O10_A2 * inv2_d1); // i1-2, i2, i3
			sca_stencil_set_location(sten,  4, -1, 0, 0, 0); sca_stencil_set_factor(sten,  4, FD_D2_O10_A1 * inv2_d1); // i1-1, i2, i3
			sca_stencil_set_location(sten,  5,  0, 0, 0, 0); sca_stencil_set_factor(sten,  5, FD_D2_O10_A0 * inv2_d1); // i1  , i2, i3
			sca_stencil_set_location(sten,  6,  1, 0, 0, 0); sca_stencil_set_factor(sten,  6, FD_D2_O10_A1 * inv2_d1); // i1+1, i2, i3
			sca_stencil_set_location(sten,  7,  2, 0, 0, 0); sca_stencil_set_factor(sten,  7, FD_D2_O10_A2 * inv2_d1); // i1+2, i2, i3
			sca_stencil_set_location(sten,  8,  3, 0, 0, 0); sca_stencil_set_factor(sten,  8, FD_D2_O10_A3 * inv2_d1); // i1+3, i2, i3
			sca_stencil_set_location(sten,  9,  4, 0, 0, 0); sca_stencil_set_factor(sten,  9, FD_D2_O10_A4 * inv2_d1); // i1+4, i2, i3
			sca_stencil_set_location(sten, 10,  5, 0, 0, 0); sca_stencil_set_factor(sten, 10, FD_D2_O10_A5 * inv2_d1); // i1+5, i2, i3
		}
		else if (fdOrder == 12)
		{
		...
		{
			sca_stencil_set_location(sten,  0, -7, 0, 0, 0); sca_stencil_set_factor(sten,  0, FD_D2_O14_A7 * inv2_d1); // i1-7, i2, i3
			sca_stencil_set_location(sten,  1, -6, 0, 0, 0); sca_stencil_set_factor(sten,  1, FD_D2_O14_A6 * inv2_d1); // i1-6, i2, i3
			sca_stencil_set_location(sten,  2, -5, 0, 0, 0); sca_stencil_set_factor(sten,  2, FD_D2_O14_A5 * inv2_d1); // i1-5, i2, i3
			sca_stencil_set_location(sten,  3, -4, 0, 0, 0); sca_stencil_set_factor(sten,  3, FD_D2_O14_A4 * inv2_d1); // i1-4, i2, i3
			sca_stencil_set_location(sten,  4, -3, 0, 0, 0); sca_stencil_set_factor(sten,  4, FD_D2_O14_A3 * inv2_d1); // i1-3, i2, i3
			sca_stencil_set_location(sten,  5, -2, 0, 0, 0); sca_stencil_set_factor(sten,  5, FD_D2_O14_A2 * inv2_d1); // i1-2, i2, i3
			sca_stencil_set_location(sten,  6, -1, 0, 0, 0); sca_stencil_set_factor(sten,  6, FD_D2_O14_A1 * inv2_d1); // i1-1, i2, i3
			sca_stencil_set_location(sten,  7,  0, 0, 0, 0); sca_stencil_set_factor(sten,  7, FD_D2_O14_A0 * inv2_d1); // i1  , i2, i3
			sca_stencil_set_location(sten,  8,  1, 0, 0, 0); sca_stencil_set_factor(sten,  8, FD_D2_O14_A1 * inv2_d1); // i1+1, i2, i3
			sca_stencil_set_location(sten,  9,  2, 0, 0, 0); sca_stencil_set_factor(sten,  9, FD_D2_O14_A2 * inv2_d1); // i1+2, i2, i3
			sca_stencil_set_location(sten, 10,  3, 0, 0, 0); sca_stencil_set_factor(sten, 10, FD_D2_O14_A3 * inv2_d1); // i1+3, i2, i3
			sca_stencil_set_location(sten, 11,  4, 0, 0, 0); sca_stencil_set_factor(sten, 11, FD_D2_O14_A4 * inv2_d1); // i1+4, i2, i3
			sca_stencil_set_location(sten, 12,  5, 0, 0, 0); sca_stencil_set_factor(sten, 12, FD_D2_O14_A5 * inv2_d1); // i1+5, i2, i3
			sca_stencil_set_location(sten, 13,  6, 0, 0, 0); sca_stencil_set_factor(sten, 13, FD_D2_O14_A6 * inv2_d1); // i1+6, i2, i3
			sca_stencil_set_location(sten, 14,  7, 0, 0, 0); sca_stencil_set_factor(sten, 14, FD_D2_O14_A7 * inv2_d1); // i1+7, i2, i3
		}
		else if (fdOrder == 16)
		{
...
Rtn_code Grid_NEC_SCA::initialize_code_FD_D2_N2(Point_type pType, const Grid& Wgrid, Myint fdOrder)
{
	...
	if (!flag_code_FD_D2_N2)
	{
		...
		{
			sca_stencil_set_location(sten, 0, 0, -3, 0, 0); sca_stencil_set_factor(sten, 0, FD_D2_O6_A3 * inv2_d2); // i1, i2-3, i3
			sca_stencil_set_location(sten, 1, 0, -2, 0, 0); sca_stencil_set_factor(sten, 1, FD_D2_O6_A2 * inv2_d2); // i1, i2-2, i3
			sca_stencil_set_location(sten, 2, 0, -1, 0, 0); sca_stencil_set_factor(sten, 2, FD_D2_O6_A1 * inv2_d2); // i1, i2-1, i3
			sca_stencil_set_location(sten, 3, 0,  0, 0, 0); sca_stencil_set_factor(sten, 3, FD_D2_O6_A0 * inv2_d2); // i1, i2  , i3
			sca_stencil_set_location(sten, 4, 0,  1, 0, 0); sca_stencil_set_factor(sten, 4, FD_D2_O6_A1 * inv2_d2); // i1, i2+1, i3
			sca_stencil_set_location(sten, 5, 0,  2, 0, 0); sca_stencil_set_factor(sten, 5, FD_D2_O6_A2 * inv2_d2); // i1, i2+2, i3
			sca_stencil_set_location(sten, 6, 0,  3, 0, 0); sca_stencil_set_factor(sten, 6, FD_D2_O6_A3 * inv2_d2); // i1, i2+3, i3
		}
		else if (fdOrder == 8)
		{
		...
		{
			sca_stencil_set_location(sten,  0, 0, -5, 0, 0); sca_stencil_set_factor(sten,  0, FD_D2_O10_A5 * inv2_d2); // i1, i2-5, i3
			sca_stencil_set_location(sten,  1, 0, -4, 0, 0); sca_stencil_set_factor(sten,  1, FD_D2_O10_A4 * inv2_d2); // i1, i2-4, i3
			sca_stencil_set_location(sten,  2, 0, -3, 0, 0); sca_stencil_set_factor(sten,  2, FD_D2_O10_A3 * inv2_d2); // i1, i2-3, i3
			sca_stencil_set_location(sten,  3, 0, -2, 0, 0); sca_stencil_set_factor(sten,  3, FD_D2_O10_A2 * inv2_d2); // i1, i2-2, i3
			sca_stencil_set_location(sten,  4, 0, -1, 0, 0); sca_stencil_set_factor(sten,  4, FD_D2_O10_A1 * inv2_d2); // i1, i2-1, i3
		...
		{
			sca_stencil_set_location(sten,  0, 0, -7, 0, 0); sca_stencil_set_factor(sten,  0, FD_D2_O14_A7 * inv2_d2); // i1, i2-7, i3
			sca_stencil_set_location(sten,  1, 0, -6, 0, 0); sca_stencil_set_factor(sten,  1, FD_D2_O14_A6 * inv2_d2); // i1, i2-6, i3
			sca_stencil_set_location(sten,  2, 0, -5, 0, 0); sca_stencil_set_factor(sten,  2, FD_D2_O14_A5 * inv2_d2); // i1, i2-5, i3
			sca_stencil_set_location(sten,  3, 0, -4, 0, 0); sca_stencil_set_factor(sten,  3, FD_D2_O14_A4 * inv2_d2); // i1, i2-4, i3
			sca_stencil_set_location(sten,  4, 0, -3, 0, 0); sca_stencil_set_factor(sten,  4, FD_D2_O14_A3 * inv2_d2); // i1, i2-3, i3
			sca_stencil_set_location(sten,  5, 0, -2, 0, 0); sca_stencil_set_factor(sten,  5, FD_D2_O14_A2 * inv2_d2); // i1, i2-2, i3
			sca_stencil_set_location(sten,  6, 0, -1, 0, 0); sca_stencil_set_factor(sten,  6, FD_D2_O14_A1 * inv2_d2); // i1, i2-1, i3
			sca_stencil_set_location(sten,  7, 0,  0, 0, 0); sca_stencil_set_factor(sten,  7, FD_D2_O14_A0 * inv2_d2); // i1, i2  , i3
			sca_stencil_set_location(sten,  8, 0,  1, 0, 0); sca_stencil_set_factor(sten,  8, FD_D2_O14_A1 * inv2_d2); // i1, i2+1, i3
			sca_stencil_set_location(sten,  9, 0,  2, 0, 0); sca_stencil_set_factor(sten,  9, FD_D2_O14_A2 * inv2_d2); // i1, i2+2, i3
			sca_stencil_set_location(sten, 10, 0,  3, 0, 0); sca_stencil_set_factor(sten, 10, FD_D2_O14_A3 * inv2_d2); // i1, i2+3, i3
			sca_stencil_set_location(sten, 11, 0,  4, 0, 0); sca_stencil_set_factor(sten, 11, FD_D2_O14_A4 * inv2_d2); // i1, i2+4, i3
			sca_stencil_set_location(sten, 12, 0,  5, 0, 0); sca_stencil_set_factor(sten, 12, FD_D2_O14_A5 * inv2_d2); // i1, i2+5, i3
			sca_stencil_set_location(sten, 13, 0,  6, 0, 0); sca_stencil_set_factor(sten, 13, FD_D2_O14_A6 * inv2_d2); // i1, i2+6, i3
			sca_stencil_set_location(sten, 14, 0,  7, 0, 0); sca_stencil_set_factor(sten, 14, FD_D2_O14_A7 * inv2_d2); // i1, i2+7, i3
		}
		else if (fdOrder == 16)
		{
...
Rtn_code Grid_NEC_SCA::initialize_code_FD_D2_N3(Point_type pType, const Grid& Wgrid, Myint fdOrder)
{
	...
	if (!flag_code_FD_D2_N3)
	{
		...
		{
			sca_stencil_set_location(sten, 0, 0, 0, -3, 0); sca_stencil_set_factor(sten, 0, FD_D2_O6_A3 * inv2_d3); // i1, i2, i3-3
			sca_stencil_set_location(sten, 1, 0, 0, -2, 0); sca_stencil_set_factor(sten, 1, FD_D2_O6_A2 * inv2_d3); // i1, i2, i3-2
			sca_stencil_set_location(sten, 2, 0, 0, -1, 0); sca_stencil_set_factor(sten, 2, FD_D2_O6_A1 * inv2_d3); // i1, i2, i3-1
			sca_stencil_set_location(sten, 3, 0, 0,  0, 0); sca_stencil_set_factor(sten, 3, FD_D2_O6_A0 * inv2_d3); // i1, i2, i3
			sca_stencil_set_location(sten, 4, 0, 0,  1, 0); sca_stencil_set_factor(sten, 4, FD_D2_O6_A1 * inv2_d3); // i1, i2, i3+1
			sca_stencil_set_location(sten, 5, 0, 0,  2, 0); sca_stencil_set_factor(sten, 5, FD_D2_O6_A2 * inv2_d3); // i1, i2, i3+2
			sca_stencil_set_location(sten, 6, 0, 0,  3, 0); sca_stencil_set_factor(sten, 6, FD_D2_O6_A3 * inv2_d3); // i1, i2, i3+3
		}
		else if (fdOrder == 8)
		{
		...
		{
			sca_stencil_set_location(sten,  0, 0, 0, -5, 0); sca_stencil_set_factor(sten,  0, FD_D2_O10_A5 * inv2_d3); // i1, i2, i3-5
			sca_stencil_set_location(sten,  1, 0, 0, -4, 0); sca_stencil_set_factor(sten,  1, FD_D2_O10_A4 * inv2_d3); // i1, i2, i3-4
			sca_stencil_set_location(sten,  2, 0, 0, -3, 0); sca_stencil_set_factor(sten,  2, FD_D2_O10_A3 * inv2_d3); // i1, i2, i3-3
			sca_stencil_set_location(sten,  3, 0, 0, -2, 0); sca_stencil_set_factor(sten,  3, FD_D2_O10_A2 * inv2_d3); // i1, i2, i3-2
			sca_stencil_set_location(sten,  4, 0, 0, -1, 0); sca_stencil_set_factor(sten,  4, FD_D2_O10_A1 * inv2_d3); // i1, i2, i3-1
			sca_stencil_set_location(sten,  5, 0, 0,  0, 0); sca_stencil_set_factor(sten,  5, FD_D2_O10_A0 * inv2_d3); // i1, i2, i3
			sca_stencil_set_location(sten,  6, 0, 0,  1, 0); sca_stencil_set_factor(sten,  6, FD_D2_O10_A1 * inv2_d3); // i1, i2, i3+1
			sca_stencil_set_location(sten,  7, 0, 0,  2, 0); sca_stencil_set_factor(sten,  7, FD_D2_O10_A2 * inv2_d3); // i1, i2, i3+2
			sca_stencil_set_location(sten,  8, 0, 0,  3, 0); sca_stencil_set_factor(sten,  8, FD_D2_O10_A3 * inv2_d3); // i1, i2, i3+3
			sca_stencil_set_location(sten,  9, 0, 0,  4, 0); sca_stencil_set_factor(sten,  9, FD_D2_O10_A4 * inv2_d3); // i1, i2, i3+4
			sca_stencil_set_location(sten, 10, 0, 0,  5, 0); sca_stencil_set_factor(sten, 10, FD_D2_O10_A5 * inv2_d3); // i1, i2, i3+5
		}
		else if (fdOrder == 12)
		{
		...
		{
			sca_stencil_set_location(sten,  0, 0, 0, -7, 0); sca_stencil_set_factor(sten,  0, FD_D2_O14_A7 * inv2_d3); // i1, i2, i3-7
			sca_stencil_set_location(sten,  1, 0, 0, -6, 0); sca_stencil_set_factor(sten,  1, FD_D2_O14_A6 * inv2_d3); // i1, i2, i3-6
			sca_stencil_set_location(sten,  2, 0, 0, -5, 0); sca_stencil_set_factor(sten,  2, FD_D2_O14_A5 * inv2_d3); // i1, i2, i3-5
			sca_stencil_set_location(sten,  3, 0, 0, -4, 0); sca_stencil_set_factor(sten,  3, FD_D2_O14_A4 * inv2_d3); // i1, i2, i3-4
			sca_stencil_set_location(sten,  4, 0, 0, -3, 0); sca_stencil_set_factor(sten,  4, FD_D2_O14_A3 * inv2_d3); // i1, i2, i3-3
			sca_stencil_set_location(sten,  5, 0, 0, -2, 0); sca_stencil_set_factor(sten,  5, FD_D2_O14_A2 * inv2_d3); // i1, i2, i3-2
			sca_stencil_set_location(sten,  6, 0, 0, -1, 0); sca_stencil_set_factor(sten,  6, FD_D2_O14_A1 * inv2_d3); // i1, i2, i3-1
			sca_stencil_set_location(sten,  7, 0, 0,  0, 0); sca_stencil_set_factor(sten,  7, FD_D2_O14_A0 * inv2_d3); // i1, i2, i3
			sca_stencil_set_location(sten,  8, 0, 0,  1, 0); sca_stencil_set_factor(sten,  8, FD_D2_O14_A1 * inv2_d3); // i1, i2, i3+1
			sca_stencil_set_location(sten,  9, 0, 0,  2, 0); sca_stencil_set_factor(sten,  9, FD_D2_O14_A2 * inv2_d3); // i1, i2, i3+2
			sca_stencil_set_location(sten, 10, 0, 0,  3, 0); sca_stencil_set_factor(sten, 10, FD_D2_O14_A3 * inv2_d3); // i1, i2, i3+3
			sca_stencil_set_location(sten, 11, 0, 0,  4, 0); sca_stencil_set_factor(sten, 11, FD_D2_O14_A4 * inv2_d3); // i1, i2, i3+4
			sca_stencil_set_location(sten, 12, 0, 0,  5, 0); sca_stencil_set_factor(sten, 12, FD_D2_O14_A5 * inv2_d3); // i1, i2, i3+5
			sca_stencil_set_location(sten, 13, 0, 0,  6, 0); sca_stencil_set_factor(sten, 13, FD_D2_O14_A6 * inv2_d3); // i1, i2, i3+6
			sca_stencil_set_location(sten, 14, 0, 0,  7, 0); sca_stencil_set_factor(sten, 14, FD_D2_O14_A7 * inv2_d3); // i1, i2, i3+7
		}
		else if (fdOrder == 16)
		{
	...
	if (!flag_code_FD_LAPLACIAN)
	{
		...
		else if (dim == DIM2)
		{
			...
			else if (fdOrder == 6)
			{
				...
				sca_stencil_set_location(sten,  1, -2,  0, 0, 0); sca_stencil_set_factor(sten,  1, FD_D2_O6_A2 * inv2_d1); // i1-2, i2,   i3
				sca_stencil_set_location(sten,  2, -1,  0, 0, 0); sca_stencil_set_factor(sten,  2, FD_D2_O6_A1 * inv2_d1); // i1-1, i2,   i3
				sca_stencil_set_location(sten,  3,  1,  0, 0, 0); sca_stencil_set_factor(sten,  3, FD_D2_O6_A1 * inv2_d1); // i1+1, i2,   i3
				sca_stencil_set_location(sten,  4,  2,  0, 0, 0); sca_stencil_set_factor(sten,  4, FD_D2_O6_A2 * inv2_d1); // i1+2, i2,   i3
				sca_stencil_set_location(sten,  5,  3,  0, 0, 0); sca_stencil_set_factor(sten,  5, FD_D2_O6_A3 * inv2_d1); // i1+3, i2,   i3
				sca_stencil_set_location(sten,  6,  0, -3, 0, 0); sca_stencil_set_factor(sten,  6, FD_D2_O6_A3 * inv2_d2); // i1,   i2-3, i3
				sca_stencil_set_location(sten,  7,  0, -2, 0, 0); sca_stencil_set_factor(sten,  7, FD_D2_O6_A2 * inv2_d2); // i1,   i2-2, i3
				sca_stencil_set_location(sten,  8,  0, -1, 0, 0); sca_stencil_set_factor(sten,  8, FD_D2_O6_A1 * inv2_d2); // i1,   i2-1, i3
				sca_stencil_set_location(sten,  9,  0,  1, 0, 0); sca_stencil_set_factor(sten,  9, FD_D2_O6_A1 * inv2_d2); // i1,   i2+1, i3
				sca_stencil_set_location(sten, 10,  0,  2, 0, 0); sca_stencil_set_factor(sten, 10, FD_D2_O6_A2 * inv2_d2); // i1,   i2+2, i3
				sca_stencil_set_location(sten, 11,  0,  3, 0, 0); sca_stencil_set_factor(sten, 11, FD_D2_O6_A3 * inv2_d2); // i1,   i2+3, i3
				sca_stencil_set_location(sten, 12,  0,  0, 0, 0); sca_stencil_set_factor(sten, 12, FD_D2_O6_A0 * inv2_d1 + FD_D2_O6_A0 * inv2_d2); // i1, i2, i3
			}
			else if (fdOrder == 8)
			{
				sca_stencil_set_location(sten,  0, -4,  0, 0, 0); sca_stencil_set_factor(sten,  0, FD_D2_O8_A4 * inv2_d1); // i1-4, i2,   i3
			...
			else if (fdOrder == 10)
			{
				...
				sca_stencil_set_location(sten,  3, -2,  0, 0, 0); sca_stencil_set_factor(sten,  3, FD_D2_O10_A2 * inv2_d1); // i1-2, i2,   i3
				sca_stencil_set_location(sten,  4, -1,  0, 0, 0); sca_stencil_set_factor(sten,  4, FD_D2_O10_A1 * inv2_d1); // i1-1, i2,   i3
				sca_stencil_set_location(sten,  5,  1,  0, 0, 0); sca_stencil_set_factor(sten,  5, FD_D2_O10_A1 * inv2_d1); // i1+1, i2,   i3
				sca_stencil_set_location(sten,  6,  2,  0, 0, 0); sca_stencil_set_factor(sten,  6, FD_D2_O10_A2 * inv2_d1); // i1+2, i2,   i3
				sca_stencil_set_location(sten,  7,  3,  0, 0, 0); sca_stencil_set_factor(sten,  7, FD_D2_O10_A3 * inv2_d1); // i1+3, i2,   i3
				sca_stencil_set_location(sten,  8,  4,  0, 0, 0); sca_stencil_set_factor(sten,  8, FD_D2_O10_A4 * inv2_d1); // i1+4, i2,   i3
				sca_stencil_set_location(sten,  9,  5,  0, 0, 0); sca_stencil_set_factor(sten,  9, FD_D2_O10_A5 * inv2_d1); // i1+5, i2,   i3
				sca_stencil_set_location(sten, 10,  0, -5, 0, 0); sca_stencil_set_factor(sten, 10, FD_D2_O10_A5 * inv2_d2); // i1,   i2-5, i3
				sca_stencil_set_location(sten, 11,  0, -4, 0, 0); sca_stencil_set_factor(sten, 11, FD_D2_O10_A4 * inv2_d2); // i1,   i2-4, i3
				sca_stencil_set_location(sten, 12,  0, -3, 0, 0); sca_stencil_set_factor(sten, 12, FD_D2_O10_A3 * inv2_d2); // i1,   i2-3, i3
				sca_stencil_set_location(sten, 13,  0, -2, 0, 0); sca_stencil_set_factor(sten, 13, FD_D2_O10_A2 * inv2_d2); // i1,   i2-2, i3
				sca_stencil_set_location(sten, 14,  0, -1, 0, 0); sca_stencil_set_factor(sten, 14, FD_D2_O10_A1 * inv2_d2); // i1,   i2-1, i3
				sca_stencil_set_location(sten, 15,  0,  1, 0, 0); sca_stencil_set_factor(sten, 15, FD_D2_O10_A1 * inv2_d2); // i1,   i2+1, i3
				sca_stencil_set_location(sten, 16,  0,  2, 0, 0); sca_stencil_set_factor(sten, 16, FD_D2_O10_A2 * inv2_d2); // i1,   i2+2, i3
				sca_stencil_set_location(sten, 17,  0,  3, 0, 0); sca_stencil_set_factor(sten, 17, FD_D2_O10_A3 * inv2_d2); // i1,   i2+3, i3
				sca_stencil_set_location(sten, 18,  0,  4, 0, 0); sca_stencil_set_factor(sten, 18, FD_D2_O10_A4 * inv2_d2); // i1,   i2+4, i3
				sca_stencil_set_location(sten, 19,  0,  5, 0, 0); sca_stencil_set_factor(sten, 19, FD_D2_O10_A5 * inv2_d2); // i1,   i2+5, i3
				sca_stencil_set_location(sten, 20,  0,  0, 0, 0); sca_stencil_set_factor(sten, 20, FD_D2_O10_A0 * inv2_d1 + FD_D2_O10_A0 * inv2_d2); // i1, i2, i3
			}
			else if (fdOrder == 12)
			{
				sca_stencil_set_location(sten,  0, -6,  0, 0, 0); sca_stencil_set_factor(sten,  0, FD_D2_O12_A6 * inv2_d1); // i1-6, i2,   i3
			...
			else if (fdOrder == 14)
			{
				...
				sca_stencil_set_location(sten,  5, -2,  0, 0, 0); sca_stencil_set_factor(sten,  5, FD_D2_O14_A2 * inv2_d1); // i1-2, i2,   i3
				sca_stencil_set_location(sten,  6, -1,  0, 0, 0); sca_stencil_set_factor(sten,  6, FD_D2_O14_A1 * inv2_d1); // i1-1, i2,   i3
				sca_stencil_set_location(sten,  7,  1,  0, 0, 0); sca_stencil_set_factor(sten,  7, FD_D2_O14_A1 * inv2_d1); // i1+1, i2,   i3
				sca_stencil_set_location(sten,  8,  2,  0, 0, 0); sca_stencil_set_factor(sten,  8, FD_D2_O14_A2 * inv2_d1); // i1+2, i2,   i3
				sca_stencil_set_location(sten,  9,  3,  0, 0, 0); sca_stencil_set_factor(sten,  9, FD_D2_O14_A3 * inv2_d1); // i1+3, i2,   i3
				sca_stencil_set_location(sten, 10,  4,  0, 0, 0); sca_stencil_set_factor(sten, 10, FD_D2_O14_A4 * inv2_d1); // i1+4, i2,   i3
				sca_stencil_set_location(sten, 11,  5,  0, 0, 0); sca_stencil_set_factor(sten, 11, FD_D2_O14_A5 * inv2_d1); // i1+5, i2,   i3
				sca_stencil_set_location(sten, 12,  6,  0, 0, 0); sca_stencil_set_factor(sten, 12, FD_D2_O14_A6 * inv2_d1); // i1+6, i2,   i3
				sca_stencil_set_location(sten, 13,  7,  0, 0, 0); sca_stencil_set_factor(sten, 13, FD_D2_O14_A7 * inv2_d1); // i1+7, i2,   i3
				sca_stencil_set_location(sten, 14,  0, -7, 0, 0); sca_stencil_set_factor(sten, 14, FD_D2_O14_A7 * inv2_d2); // i1,   i2-7, i3
				sca_stencil_set_location(sten, 15,  0, -6, 0, 0); sca_stencil_set_factor(sten, 15, FD_D2_O14_A6 * inv2_d2); // i1,   i2-6, i3
				sca_stencil_set_location(sten, 16,  0, -5, 0, 0); sca_stencil_set_factor(sten, 16, FD_D2_O14_A5 * inv2_d2); // i1,   i2-5, i3
				sca_stencil_set_location(sten, 17,  0, -4, 0, 0); sca_stencil_set_factor(sten, 17, FD_D2_O14_A4 * inv2_d2); // i1,   i2-4, i3
				sca_stencil_set_location(sten, 18,  0, -3, 0, 0); sca_stencil_set_factor(sten, 18, FD_D2_O14_A3 * inv2_d2); // i1,   i2-3, i3
				sca_stencil_set_location(sten, 19,  0, -2, 0, 0); sca_stencil_set_factor(sten, 19, FD_D2_O14_A2 * inv2_d2); // i1,   i2-2, i3
				sca_stencil_set_location(sten, 20,  0, -1, 0, 0); sca_stencil_set_factor(sten, 20, FD_D2_O14_A1 * inv2_d2); // i1,   i2-1, i3
				sca_stencil_set_location(sten, 21,  0,  1, 0, 0); sca_stencil_set_factor(sten, 21, FD_D2_O14_A1 * inv2_d2); // i1,   i2+1, i3
				sca_stencil_set_location(sten, 22,  0,  2, 0, 0); sca_stencil_set_factor(sten, 22, FD_D2_O14_A2 * inv2_d2); // i1,   i2+2, i3
				sca_stencil_set_location(sten, 23,  0,  3, 0, 0); sca_stencil_set_factor(sten, 23, FD_D2_O14_A3 * inv2_d2); // i1,   i2+3, i3
				sca_stencil_set_location(sten, 24,  0,  4, 0, 0); sca_stencil_set_factor(sten, 24, FD_D2_O14_A4 * inv2_d2); // i1,   i2+4, i3
				sca_stencil_set_location(sten, 25,  0,  5, 0, 0); sca_stencil_set_factor(sten, 25, FD_D2_O14_A5 * inv2_d2); // i1,   i2+5, i3
				sca_stencil_set_location(sten, 26,  0,  6, 0, 0); sca_stencil_set_factor(sten, 26, FD_D2_O14_A6 * inv2_d2); // i1,   i2+6, i3
				sca_stencil_set_location(sten, 27,  0,  7, 0, 0); sca_stencil_set_factor(sten, 27, FD_D2_O14_A7 * inv2_d2); // i1,   i2+7, i3
				sca_stencil_set_location(sten, 28,  0,  0, 0, 0); sca_stencil_set_factor(sten, 28, FD_D2_O14_A0 * inv2_d1 + FD_D2_O14_A0 * inv2_d2); // i1, i2, i3
			}
			else if (fdOrder == 16)
			{
				sca_stencil_set_location(sten,  0, -8,  0, 0, 0); sca_stencil_set_factor(sten,  0, FD_D2_O16_A8 * inv2_d1); // i1-8, i2,   i3
		...
		else if (dim == DIM3)
		{
			...
			else if (fdOrder == 6)
			{
				...
				sca_stencil_set_location(sten, 10,  0,  2,  0, 0); sca_stencil_set_factor(sten, 10, FD_D2_O6_A2 * inv2_d2); // i1,   i2+2, i3
				sca_stencil_set_location(sten, 11,  0,  3,  0, 0); sca_stencil_set_factor(sten, 11, FD_D2_O6_A3 * inv2_d2); // i1,   i2+3, i3
				sca_stencil_set_location(sten, 12,  0,  0, -3, 0); sca_stencil_set_factor(sten, 12, FD_D2_O6_A3 * inv2_d3); // i1,   i2,   i3-3
				sca_stencil_set_location(sten, 13,  0,  0, -2, 0); sca_stencil_set_factor(sten, 13, FD_D2_O6_A2 * inv2_d3); // i1,   i2,   i3-2
				sca_stencil_set_location(sten, 14,  0,  0, -1, 0); sca_stencil_set_factor(sten, 14, FD_D2_O6_A1 * inv2_d3); // i1,   i2,   i3-1
				sca_stencil_set_location(sten, 15,  0,  0,  1, 0); sca_stencil_set_factor(sten, 15, FD_D2_O6_A1 * inv2_d3); // i1,   i2,   i3+1
				sca_stencil_set_location(sten, 16,  0,  0,  2, 0); sca_stencil_set_factor(sten, 16, FD_D2_O6_A2 * inv2_d3); // i1,   i2,   i3+2
				sca_stencil_set_location(sten, 17,  0,  0,  3, 0); sca_stencil_set_factor(sten, 17, FD_D2_O6_A3 * inv2_d3); // i1,   i2,   i3+3
				sca_stencil_set_location(sten, 18,  0,  0,  0, 0); sca_stencil_set_factor(sten, 18, FD_D2_O6_A0 * inv2_d1 + FD_D2_O6_A0 * inv2_d2 + FD_D2_O6_A0 * inv2_d3); // i1, i2, i3
			}
			else if (fdOrder == 8)
			{
				sca_stencil_set_location(sten,  0, -4,  0,  0, 0); sca_stencil_set_factor(sten,  0, FD_D2_O8_A4 * inv2_d1); // i1-4, i2,   i3
			...
			else if (fdOrder == 10)
			{
				...
				sca_stencil_set_location(sten, 18,  0,  4,  0, 0); sca_stencil_set_factor(sten, 18, FD_D2_O10_A4 * inv2_d2); // i1,   i2+4, i3
				sca_stencil_set_location(sten, 19,  0,  5,  0, 0); sca_stencil_set_factor(sten, 19, FD_D2_O10_A5 * inv2_d2); // i1,   i2+5, i3
				sca_stencil_set_location(sten, 20,  0,  0, -5, 0); sca_stencil_set_factor(sten, 20, FD_D2_O10_A5 * inv2_d3); // i1,   i2,   i3-5
				sca_stencil_set_location(sten, 21,  0,  0, -4, 0); sca_stencil_set_factor(sten, 21, FD_D2_O10_A4 * inv2_d3); // i1,   i2,   i3-4
				sca_stencil_set_location(sten, 22,  0,  0, -3, 0); sca_stencil_set_factor(sten, 22, FD_D2_O10_A3 * inv2_d3); // i1,   i2,   i3-3
				sca_stencil_set_location(sten, 23,  0,  0, -2, 0); sca_stencil_set_factor(sten, 23, FD_D2_O10_A2 * inv2_d3); // i1,   i2,   i3-2
				sca_stencil_set_location(sten, 24,  0,  0, -1, 0); sca_stencil_set_factor(sten, 24, FD_D2_O10_A1 * inv2_d3); // i1,   i2,   i3-1
				sca_stencil_set_location(sten, 25,  0,  0,  1, 0); sca_stencil_set_factor(sten, 25, FD_D2_O10_A1 * inv2_d3); // i1,   i2,   i3+1
				sca_stencil_set_location(sten, 26,  0,  0,  2, 0); sca_stencil_set_factor(sten, 26, FD_D2_O10_A2 * inv2_d3); // i1,   i2,   i3+2
				sca_stencil_set_location(sten, 27,  0,  0,  3, 0); sca_stencil_set_factor(sten, 27, FD_D2_O10_A3 * inv2_d3); // i1,   i2,   i3+3
				sca_stencil_set_location(sten, 28,  0,  0,  4, 0); sca_stencil_set_factor(sten, 28, FD_D2_O10_A4 * inv2_d3); // i1,   i2,   i3+4
				sca_stencil_set_location(sten, 29,  0,  0,  5, 0); sca_stencil_set_factor(sten, 29, FD_D2_O10_A5 * inv2_d3); // i1,   i2,   i3+5
				sca_stencil_set_location(sten, 30,  0,  0,  0, 0); sca_stencil_set_factor(sten, 30, FD_D2_O10_A0 * inv2_d1 + FD_D2_O10_A0 * inv2_d2 + FD_D2_O10_A0 * inv2_d3); // i1, i2, i3
			}
			else if (fdOrder == 12)
			{
				sca_stencil_set_location(sten,  0, -6,  0,  0, 0); sca_stencil_set_factor(sten,  0, FD_D2_O12_A6 * inv2_d1); // i1-6, i2,   i3
			...
			else if (fdOrder == 14)
			{
				...
				sca_stencil_set_location(sten, 26,  0,  6,  0, 0); sca_stencil_set_factor(sten, 26, FD_D2_O14_A6 * inv2_d2); // i1,   i2+6, i3
				sca_stencil_set_location(sten, 27,  0,  7,  0, 0); sca_stencil_set_factor(sten, 27, FD_D2_O14_A7 * inv2_d2); // i1,   i2+7, i3
				sca_stencil_set_location(sten, 28,  0,  0, -7, 0); sca_stencil_set_factor(sten, 28, FD_D2_O14_A7 * inv2_d3); // i1,   i2,   i3-7
				sca_stencil_set_location(sten, 29,  0,  0, -6, 0); sca_stencil_set_factor(sten, 29, FD_D2_O14_A6 * inv2_d3); // i1,   i2,   i3-6
				sca_stencil_set_location(sten, 30,  0,  0, -5, 0); sca_stencil_set_factor(sten, 30, FD_D2_O14_A5 * inv2_d3); // i1,   i2,   i3-5
				sca_stencil_set_location(sten, 31,  0,  0, -4, 0); sca_stencil_set_factor(sten, 31, FD_D2_O14_A4 * inv2_d3); // i1,   i2,   i3-4
				sca_stencil_set_location(sten, 32,  0,  0, -3, 0); sca_stencil_set_factor(sten, 32, FD_D2_O14_A3 * inv2_d3); // i1,   i2,   i3-3
				sca_stencil_set_location(sten, 33,  0,  0, -2, 0); sca_stencil_set_factor(sten, 33, FD_D2_O14_A2 * inv2_d3); // i1,   i2,   i3-2
				sca_stencil_set_location(sten, 34,  0,  0, -1, 0); sca_stencil_set_factor(sten, 34, FD_D2_O14_A1 * inv2_d3); // i1,   i2,   i3-1
				sca_stencil_set_location(sten, 35,  0,  0,  1, 0); sca_stencil_set_factor(sten, 35, FD_D2_O14_A1 * inv2_d3); // i1,   i2,   i3+1
				sca_stencil_set_location(sten, 36,  0,  0,  2, 0); sca_stencil_set_factor(sten, 36, FD_D2_O14_A2 * inv2_d3); // i1,   i2,   i3+2
				sca_stencil_set_location(sten, 37,  0,  0,  3, 0); sca_stencil_set_factor(sten, 37, FD_D2_O14_A3 * inv2_d3); // i1,   i2,   i3+3
				sca_stencil_set_location(sten, 38,  0,  0,  4, 0); sca_stencil_set_factor(sten, 38, FD_D2_O14_A4 * inv2_d3); // i1,   i2,   i3+4
				sca_stencil_set_location(sten, 39,  0,  0,  5, 0); sca_stencil_set_factor(sten, 39, FD_D2_O14_A5 * inv2_d3); // i1,   i2,   i3+5
				sca_stencil_set_location(sten, 40,  0,  0,  6, 0); sca_stencil_set_factor(sten, 40, FD_D2_O14_A6 * inv2_d3); // i1,   i2,   i3+6
				sca_stencil_set_location(sten, 41,  0,  0,  7, 0); sca_stencil_set_factor(sten, 41, FD_D2_O14_A7 * inv2_d3); // i1,   i2,   i3+7
				sca_stencil_set_location(sten, 42,  0,  0,  0, 0); sca_stencil_set_factor(sten, 42, FD_D2_O14_A0 * inv2_d1 + FD_D2_O14_A0 * inv2_d2 + FD_D2_O14_A0 * inv2_d3); // i1, i2, i3
			}
			else if (fdOrder == 16)
			{
				sca_stencil_set_location(sten,  0, -8,  0,  0, 0); sca_stencil_set_factor(sten,  0, FD_D2_O16_A8 * inv2_d1); // i1-8, i2,   i3
