...
#ifndef HPCSCAN_GRID_CUDA_REF_H_
#define HPCSCAN_GRID_CUDA_REF_H_
...
class Grid_Cuda_Ref : public Grid
{
public:

	// constructor
	Grid_Cuda_Ref(Grid_type) ;

	// constructor
	Grid_Cuda_Ref(Grid_type, Dim_type, Myint64, Myint64, Myint64) ;
