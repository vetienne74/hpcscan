...
\frame{
  ...
  {\scriptsize
  \begin{table}
    \caption{\scriptsize Bandwidth GB/s \footnote{\scriptsize \textcolor{blue}{Updated Sep 11, 2020}} }
    \label{table_memory}
...
\frame{
  ...
  {\scriptsize
  \begin{table}
    \caption{\scriptsize Bandwidth GPoint/s \footnote{\scriptsize \textcolor{blue}{Updated Sep 11, 2020}} }
    \label{table_memory}
    \begin{tabular}{@{}cccccc}
      \# threads & Fill & Copy & Add & Multiply & Add+Update \\
      \hline
...
\frame{
  ...
  \item Add+Update at 10 Gpoint/s (= pressure update in acoustic wave propagator without FD)
  \end{itemize}
...
\frame{
  ...
  \begin{table}
    ...
    \label{table_memory}
    \begin{tabular}{@{}cccccc}
      Grid   & Fill & Max. err. & L1 err. & Get max. & Get min. \\
      \hline
      Small  & 58   & 72        & 122     & 125      & 125      \\
      Medium & 54   & 91        & 124     & 127      & 127      \\
    \end{tabular}
  \end{table}
  }
  ...
  \begin{table}
    ...
    \begin{tabular}{@{}cccccc}
      Grid   & Fill & Max. err. & L1 err. & Get max. & Get min. \\
      \hline
      Small  & 14.4  & 9.0      & 15.2    & 31.3     & 31.2    \\
      Medium & 13.4  & 11.4     & 15.5    & 31.8     & 31.8     \\
    \end{tabular}
  \end{table}
  }
  ...
  Reproduce results with \texttt{./script/testCase\_Grid/runMediumGridShaheen.sh}
...
\frame{
  ...
  \item {\bf Low perf for Fill: 54-58 GB/s (40-43 \% Peak Mem. BW)}
...
\frame{
  ...
  \item Strong scalaibity: Grid 1000 x 1000 x 1000 (4 GB)
  \item Weak scalaibity: Grids from 4 GB (1 proc) to 32 GB (8 proc)
...
\frame{
  ...
  \item Typical stencils of interest for geophysical applications
    ...
    \end{itemize}
  \item Parallel efficiency with 8 VEs 55 to 86 \% (depends on workload on Shaheen)
  \end{itemize}
}
